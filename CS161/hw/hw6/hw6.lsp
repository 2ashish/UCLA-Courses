;
; CS161 Spring 2022 HW6 Problem 3: Graph coloring to SAT conversion
;
...
(defun at-most-cur (cur L)
    (cond
        ((null L)NIL)
        (t (append (list (list (- 0 cur) (- 0 (car L)) )) (at-most-cur cur (cdr L)) ))
    )
)
...
(defun at-most-one-color (n c k)
    (cond
        ...
        (t (let
                (
                    (at-most-right (at-most-one-color n (+ c 1) k))
                    (at-least-right (at-least-one-color n (+ c 1) k))
                    (cur (node2var n c k))
                )
                (append (at-most-cur cur at-least-right) at-most-right )
            )
        )
    )
)
...
(defun generate-edge-color-clause (e c k)
    (cond
        ((> c k)NIL)
        (t (let*
                (
                    (n1 (car e))
                    (n2 (cadr e))
                    (var1 (node2var n1 c k))
                    (var2 (node2var n2 c k))
                )
                (append (list (list (- 0 var1) (- 0 var2) ) ) (generate-edge-color-clause e (+ c 1) k) )
            )
        )
    )
)
...
(defun generate-edge-clauses (e k)
    (generate-edge-color-clause e 1 k)  
)
...
;testcases
;(write (at-least-one-color 2 1 4))                          (FRESH-LINE)
;(write (at-least-one-color 2 4 4))                          (FRESH-LINE)
;(write (at-least-one-color 3 1 3))                          (FRESH-LINE)
;(write (at-least-one-color 4 1 2))                          (FRESH-LINE)
;
;(write (at-most-one-color 2 1 4))                          (FRESH-LINE)
;(write (at-most-one-color 2 4 4))                          (FRESH-LINE)
;(write (at-most-one-color 3 1 3))                          (FRESH-LINE)
;(write (at-most-one-color 4 1 2))                          (FRESH-LINE)
;
;(write (generate-node-clauses 2 4))                          (FRESH-LINE)
;(write (generate-node-clauses 3 4))                          (FRESH-LINE)
;(write (generate-node-clauses 3 3))                          (FRESH-LINE)
;(write (generate-node-clauses 4 2))                          (FRESH-LINE)
;
;(write (generate-edge-clauses '(2 3)' 4))                          (FRESH-LINE)
;(write (generate-edge-clauses '(1 3)' 4))                          (FRESH-LINE)
;(write (generate-edge-clauses '(3 5)' 3))                          (FRESH-LINE)
;(write (generate-edge-clauses '(2 5)' 2))                          (FRESH-LINE)
