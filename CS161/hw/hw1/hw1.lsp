...
; (write (TREE-CONTAINS 1 NIL))                       (FRESH-LINE)
...
; (write (TREE-CONTAINS 4 '((1 2 3) 5 (6 8 (9 10 (11 12 13))))))    (FRESH-LINE)
; (write (TREE-CONTAINS 1 '((1 2 3) 5 (6 8 (9 10 (11 12 13))))))    (FRESH-LINE)
; (write (TREE-CONTAINS 13 '((1 2 3) 5 (6 8 (9 10 (11 12 13))))))    (FRESH-LINE)

; ;TREE-MAX
; (write-line "TREE-MAX testcases")
; (write (TREE-MAX NIL ))                       (FRESH-LINE)
...
; (write (TREE-ORDER NIL ))                       (FRESH-LINE)
...
; (write (TREE-ORDER '((1 2 3) 5 (6 8 (9 10 (11 12 13))))))    (FRESH-LINE)

; ;SUB-LIST
; (write-line "SUB-LIST testcases")
; (write (SUB-LIST NIL 0 0))                  (FRESH-LINE)
...
; (write (SUB-LIST '(a b c d) 2 5))           (FRESH-LINE)
; (write (SUB-LIST '(a b c d) 5 5))           (FRESH-LINE)
; (write (SUB-LIST '(a (b b) c (d e f)) 1 3)) (FRESH-LINE)

; ;SPLIT-LIST
; (write-line "SPLIT-LIST testcases")   
; (write (SPLIT-LIST NIL ))                  (FRESH-LINE)
...
; (write (BTREE-HEIGHT NIL))                                (FRESH-LINE)
...
; (write (LIST2BTREE '(NIL)))                   (FRESH-LINE)
...
; (write (BTREE2LIST NIL))                                (FRESH-LINE)
...
; (write (LIST2BTREE(BTREE2LIST 'NIL)))                   (FRESH-LINE)
; (write (BTREE2LIST(LIST2BTREE '(NIL))))                   (FRESH-LINE)
...
; (write (IS-SAME NIL NIL))                             (FRESH-LINE)
...
; (write (FLATTEN-APPEND NIL '2))                      (FRESH-LINE)
...
; (write (FLATTEN-APPEND '() '(1 2 ((3) 4) 5 (6 7) 8)))   (FRESH-LINE)

; (write (TREE-CONTAINS 11 '((1 2 3) 5 (6 8 (9 10 (11 12 13)))))) (FRESH-LINE)

; (write (TREE-MAX 3))  (FRESH-LINE)
; (write (TREE-MAX '((1 2 3) 7 9))) (FRESH-LINE)
; (write (TREE-MAX '((1 2 3) 5 (6 8 (9 10 (11 12 13)))))) (FRESH-LINE)

; (write (SUB-LIST '(a b (c d) e) 1 3)) (FRESH-LINE)
; (write (SUB-LIST '() 0 3)) (FRESH-LINE)

; (write (BTREE2LIST '())) (FRESH-LINE)

; (write (IS-SAME '((1 2 4) 7 8) '((1 2 3) 7 8))) (FRESH-LINE)
; (write (IS-SAME '((1 2 3) (7 8) (9 (11 15))) '((1 2 3) (7 8) (9 (11 15))))) (FRESH-LINE)
; (write (IS-SAME '((1 2 3) (7 8) (9 (11 15))) '((1 2 3) (7 8) (9 (5 15))))) (FRESH-LINE)
; (write-line "Done")
; ;(write '(NIL NIL))
